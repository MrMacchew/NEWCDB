...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { make: @computer.make, model: @computer.model, name: @computer.name, serial: @computer.serial, wtag: @computer.wtag }
    end
  ...
  test "should update computer" do
    patch :update, id: @computer, computer: { make: @computer.make, model: @computer.model, name: @computer.name, serial: @computer.serial, wtag: @computer.wtag }
    assert_redirected_to computer_path(assigns(:computer))
  end
